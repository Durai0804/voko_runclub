...
import { Share2, Clock, Sparkles, ArrowRight, ChevronDown } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div>
        ...
        <main className="h-screen overflow-y-auto snap-y snap-mandatory scroll-smooth bg-[var(--voko-bg)] selection:bg-[var(--voko-accent)] selection:text-black text-[var(--voko-text)] relative">
          ...
          <div className="relative z-10">
            {/* Section 1: Title + Glass Images */}
            <section className="h-screen w-full snap-start pt-24 pb-7">
              <div className="max-w-[1200px] mx-auto px-4 md:px-6 h-full flex flex-col">
                ...
                <div className="flex flex-col gap-4 mb-4">
                  <div className="flex items-center gap-4 animate-in fade-in slide-in-from-left duration-700">
                    ...
                    <div className="h-[1px] flex-1 bg-gradient-to-r from-[var(--voko-text)]/20 to-transparent" />
                  </div>

                  <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
                    <h1 className="text-[36px] md:text-[56px] lg:text-[72px] font-black tracking-[-0.07em] text-[var(--voko-text)] leading-[0.85] uppercase italic animate-in fade-in slide-in-from-bottom duration-1000">
                      {event.title}
                    </h1>
                ...
                <div className="flex-1 min-h-0 animate-in fade-in slide-in-from-bottom duration-1000 [animation-delay:600ms]">
                  <div className="relative w-full h-full bg-black/5 backdrop-blur-sm rounded-[56px] overflow-hidden group border border-[var(--voko-text)]/10 shadow-[0_40px_100px_rgba(0,0,0,0.1)]">
                    <div className="absolute inset-0 opacity-40 pointer-events-none">
                      <div className="absolute inset-0 bg-gradient-to-br from-[var(--voko-accent)]/20 via-transparent to-transparent" />
                    </div>
                    ...
                    <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end pointer-events-none">
                      <div className="flex flex-col gap-3">
                        ...
                        <div className="w-48 h-[1px] bg-[var(--voko-text)]/10 relative overflow-hidden">
                          <div className="absolute inset-0 bg-[var(--voko-accent)] animate-progress-loop" />
                        </div>
                      </div>
                ...
                <div className="pt-3 flex justify-center">
                  <button
                    ...
                    className="group flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--voko-text)]/5 border border-[var(--voko-text)]/10 backdrop-blur-2xl hover:border-[var(--voko-accent)]/40 transition-colors"
                    aria-label="Scroll to event details"
                  >
                    <span className="text-[10px] font-black uppercase tracking-[0.35em] text-[var(--voko-text)]/60 group-hover:text-[var(--voko-text)] transition-colors">SCROLL</span>
                    <ChevronDown size={14} className="text-[var(--voko-accent)] group-hover:translate-y-0.5 transition-transform" />
                  </button>
                </div>
              </div>
            </section>

            {/* Section 2: Details + Registration */}
            <section id="event-details-section" className="min-h-screen w-full snap-start pt-24 pb-40">
